...
class ProfileController extends Controller
{
    ...
    public function showprofilemember()
    {
        ...
        return view('member.profile', compact('profiles'));
    }
    public function updateprofilememberindex($id)
    {
        $profiles = User::find($id);

        return view('member.updateprofile', compact('profiles'));
    }
    ...
    public function updatepasswordmemberindex($id)
    {
        ...
        return view('member.updatepassword', compact('profiles'));
    }
    ...
    public function updateprofileadminindex($id)
    {
        ...
        return view('admin.updateprofile', compact('profiles'));
    }
    ...
    public function updatepasswordadminindex($id)
    {
        ...
        return view('admin.updatepassword', compact('profiles'));
    }
