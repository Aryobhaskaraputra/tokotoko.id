...
class GuideController extends Controller
{
    ...
    public function guideindexmember()
    {
        ...
        return view('member.guide', compact('beginner', 'general', 'gacha'));
    }
    public function showguidemember($id)
    {
        $guides = Guide::all()->find($id);

        return view('member.viewguide', compact('guides'));
    }
    ...
    public function guideindexadmin()
    {
        ...
        return view('admin.guide', compact('beginner', 'general', 'gacha'));
    }
    public function showguideadmin($id)
    {
        $guides = Guide::all()->find($id);

        return view('admin.viewguide', compact('guides'));
    }
    ...
    public function updateguideindex($id)
    {
        ...
        return view('admin.updateguide', compact('guides'));
    }
