...
<div>
    ...
    <div style="display: flex; justify-content: center; color: white">
        <form method="post" enctype="multipart/form-data" action="{{ route('Create Blog') }}" style="width: 600px">
            @csrf
            <div class="mb-3">
                <label  for="exampleFormControlInput1" class="form-label">Blog Title <span style="color:red;">*</span></label>
              ...
              <div class="mb-3">
                <label for="exampleFormControlTextarea1" class="form-label">Blog Description <span style="color:red;">*</span></label>
