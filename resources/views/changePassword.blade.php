              ...
              <div class="col-md-6 col-lg-7 d-flex align-items-center">
                <div class="card-body p-4 p-lg-5 text-black">
                  <form action="{{route('guest.method.updatePassword')}}" method="post" enctype="multipart/form-data">
                    ...
                    <h6 class="fw-normal mb-1 pb-1" style="letter-spacing: 1px;">New Password <span style="color:red;">*</span></h6>
                    <input type="email" name="email_id" id="" style="visibility:hidden;" value="{{$email->email}}">
                    <div class="form-outline mb-4">
                        <input type="password" id="form2Example17" class="form-control form-control-lg" placeholder="Enter new password!" name="new_pass">
                    </div>
